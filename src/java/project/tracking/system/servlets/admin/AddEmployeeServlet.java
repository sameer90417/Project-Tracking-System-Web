...
public class AddEmployeeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String profile = request.getParameter("emp_profile");
            String email = request.getParameter("emp_email");
            String password = request.getParameter("emp_password");
            String cpassword = request.getParameter("emp_cpassword");

            if (!name.trim().equals("") && !profile.trim().equals("") && !email.trim().equals("") && !password.trim().equals("")) {
                if (password.trim().equals(cpassword)) {
                    Employee employee = new Employee(name, profile, email);
